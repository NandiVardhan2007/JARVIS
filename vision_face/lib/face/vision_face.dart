...
/// The animated VISION face. Give it a [VisionSnapshot] and it continuously
...
class VisionFace extends StatefulWidget {
  ...
  const VisionFace({super.key, required this.snapshot, this.size = 360});

  @override
  State<VisionFace> createState() => _VisionFaceState();
}

class _VisionFaceState extends State<VisionFace>
  ...
  Emotion _displayEmotion(VisionSnapshot s) {
