...
/// Enterprise-grade VISION boot splash screen with:
/// - HUD data rings rotating around a reactor core
/// - Hex grid particle background
/// - Animated text boot sequence (line by line)
/// - Glitch flicker on the VISION logo
/// - Auto-dismisses after ~4 seconds
class VisionSplashScreen extends StatefulWidget {
  final VoidCallback onComplete;
  const VisionSplashScreen({super.key, required this.onComplete});

  @override
  State<VisionSplashScreen> createState() => _VisionSplashScreenState();
}

class _VisionSplashScreenState extends State<VisionSplashScreen>
              ...
              child: Column(
                ...
                children: [
                  ...
                  Stack(
                    ...
                    children: [
                      _logoText(color: VisionTheme.accent),
                      if (_glitching)
                        Opacity(
                        ...
                        return Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              ...
                              shadows: [
                                Shadow(
                                  color: VisionTheme.accent.withAlpha(120),
                                  blurRadius: 8,
                                ),
                              ],
                            ),
