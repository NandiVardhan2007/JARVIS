...
/// Now-playing panel driven by the VISION media tool. Controls send real
    ...
    return const SizedBox(
      ...
      child: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.music_note_outlined, color: VisionTheme.textDim, size: 30),
            SizedBox(height: 8),
            Text('Nothing playing',
                style: TextStyle(color: VisionTheme.textDim, fontSize: 13)),
          ],
        ),
      ),
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                    style: const TextStyle(color: VisionTheme.textDim, fontSize: 12.5),
                  ),
                ],
              ),
            ),
  ...
  Widget _controlButton({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon,
            color: filled ? Colors.white : VisionTheme.textPrimary, size: filled ? 26 : 22),
      ),
    );
  }
}
