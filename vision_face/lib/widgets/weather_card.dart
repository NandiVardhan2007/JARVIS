...
class _WeatherCardState extends State<WeatherCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: VisionTheme.glassCard(accent),
  ...
  Widget _placeholder() {
    return SizedBox(
      ...
      child: Center(
        child: _error != null
            ? Text(_error!, style: const TextStyle(color: VisionTheme.textDim))
  ...
  Widget _content(Weather w) {
    return Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.place_outlined, size: 15, color: VisionTheme.textDim),
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  w.description,
                  style: const TextStyle(color: VisionTheme.textDim, fontSize: 13),
                ),
              ],
            ),
          ],
        ...
        Text(
          ...
          style: const TextStyle(color: VisionTheme.textDim, fontSize: 11.5),
        ),
  ...
  Widget _dayCell(WeatherDay d) {
    return Column(
      children: [
        Text(d.label,
            style: const TextStyle(color: VisionTheme.textDim, fontSize: 11)),
        ...
        Text(
          ...
          style: const TextStyle(
              color: VisionTheme.textPrimary, fontSize: 11.5, fontWeight: FontWeight.w500),
        ),
      ],
    );
  }
