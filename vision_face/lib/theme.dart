...
final ValueNotifier<ThemeMode> visionThemeMode = ValueNotifier(ThemeMode.dark);

void toggleVisionTheme() {
  visionThemeMode.value =
      visionThemeMode.value == ThemeMode.dark ? ThemeMode.light : ThemeMode.dark;
}
...
/// Global look-and-feel for the VISION frontend. Deep-space dark canvas so the
/// glowing orb and cards read with maximum contrast (default). A light
/// variant is also available for VisionTheme.buildLight().
class VisionTheme {
