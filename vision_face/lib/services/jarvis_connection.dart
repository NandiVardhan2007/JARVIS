...
/// Owns the live link to the VISION backend (via the Python `vision_bridge.py`
...
/// believable VISION so the face, mouth, weather and player all come alive with
/// no backend running.
class VisionConnection extends ChangeNotifier {
  VisionConnection({this.url = 'ws://127.0.0.1:8765'});

  String url;
  VisionSnapshot snapshot = const VisionSnapshot();
