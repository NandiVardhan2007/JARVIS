...
/// Auth state broadcast by the JARVIS Python backend via WebSocket.
enum AuthState {
...
class JarvisAuthScreen extends StatefulWidget {
  ...
  @override
  State<JarvisAuthScreen> createState() => _JarvisAuthScreenState();
}

class _JarvisAuthScreenState extends State<JarvisAuthScreen>
  ...
  @override
  void didUpdateWidget(JarvisAuthScreen old) {
